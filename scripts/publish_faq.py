...
def create_telegraph_page():
    ...
    content = [
        ...
        {"tag": "p", "children": [{"tag": "em", "children": ["תשובה: אם משתמש צריך לעבור אימות, הבוט ישלח לו בפרטי שאלת אימות אקראית שבחרת מראש. המשתמש יצטרך לענות נכון בתוך הזמן ומספר הניסיונות שהגדרת (למשל: 3 ניסיונות בתוך 5 דקות) כדי להיות מאושר."]}]},
        {"tag": "br", "children": []},
